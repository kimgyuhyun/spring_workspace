...
-- books 테이블에 데잍터 등록
INSERT INTO books (title, author, publishers_id) VALUES ('생성형 AI 업무 혁신', '박찬규, 윤가희', 1);
INSERT INTO books (title, author, publishers_id) VALUES ('브릭메카의 미니 변신 로봇', '최상철', 2);
INSERT INTO books (title, author, publishers_id) VALUES ('AI가 훔쳐간 인문학', '김철수', 1);

-- review 테이블에 데이터 등록
INSERT INTO reviews (book_id review_text) VALUES (1, '매우 유횽한 책이었습니다.');
